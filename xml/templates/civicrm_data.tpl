...
INSERT INTO civicrm_uf_field
       ...
       (2,  1,           'last_name',             1,           0,           2,      'User and User Admin Only', 0,           1,             NULL,             '{ts escape="sql"}Last Name{/ts}',             		'Individual',  '{ts escape="sql"}First and last name will be shared with other visitors to the site.{/ts}',  NULL),
       ...
       (6,  1,           'country',               0,           0,           6,      'User and User Admin Only', 0,           1,             1,                '{ts escape="sql"}Country (Home){/ts}',        		'Contact',     '{ts escape="sql"}Your state/province and country of residence will be shared with others so folks can find others in their community.{/ts}',  NULL),
       ...
       (33,  8,           'country',               0,           0,           4,      'User and User Admin Only', 0,           1,             1,                '{ts escape="sql"}Country (Home){/ts}',        		'Contact',     NULL,  NULL),
       (34,  8,           'state_province',        0,           0,           5,      'User and User Admin Only', 1,           1,             1,                '{ts escape="sql"}State (Home){/ts}',          		'Contact',     NULL,  NULL),
...
VALUES 
    ( @domainID, 'Hourly' , NULL, '{ts escape="sql" skip="true"}Send Scheduled Mailings{/ts}',      '{ts escape="sql" skip="true"}Sends out scheduled CiviMail mailings{/ts}',                                                       'civicrm_api3', 'job', 'process_mailing',         NULL, 0),
    ...
    ( @domainID, 'Always' , NULL, '{ts escape="sql" skip="true"}Update Membership Statuses and Send Renewal Reminders{/ts}', '{ts escape="sql" skip="true"}Updates membership statuses and conditionally sends renewal reminders{/ts}', 'civicrm_api3', 'job', 'process_membership',   NULL, 0),
