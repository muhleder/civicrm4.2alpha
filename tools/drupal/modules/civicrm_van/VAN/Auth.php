...
class VAN_Auth {
    ...
    const
        DATABASE_NODE = 'MyVoterFile',
        WSDL_URL      = 'https://secure.securevan.com/Services/V3/PersonService.asmx?wsdl',
        VAN_NS        = 'https://api.securevan.com/Services/V3/';
    ...
    static function invoke( $method, &$params ) {
        self::initialize( );
